...
class TestMain(unittest.TestCase):
    ...
    @patch('rock_paper_scissors.__main__.play_multiple_rounds', side_effect=KeyboardInterrupt)
    @patch('builtins.input', return_value='rock')
    ...
    @patch('rock_paper_scissors.__main__.play_multiple_rounds', side_effect=Exception('Test error'))
    @patch('builtins.input', return_value='rock')
    @patch('sys.stderr', new_callable=StringIO)
