...
class TestPlayGame(unittest.TestCase):
    ...
    @patch(
        "rock_paper_scissors.rock_paper_scissors.get_user_choice", return_value="rock"
    )
    @patch(
        "rock_paper_scissors.rock_paper_scissors.get_computer_choice",
    ...
    @patch(
        "rock_paper_scissors.rock_paper_scissors.get_user_choice", return_value="paper"
    )
    @patch(
        "rock_paper_scissors.rock_paper_scissors.get_computer_choice",
        return_value="paper",
    ...
    @patch(
        "rock_paper_scissors.rock_paper_scissors.get_user_choice",
        return_value="scissors",
    )
    @patch(
        "rock_paper_scissors.rock_paper_scissors.get_computer_choice",
